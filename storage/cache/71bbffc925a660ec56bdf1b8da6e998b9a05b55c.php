            ...
            <div class="col-sm-3">
                <div class="widget">
                    ...
                    <p>The languages only differ in their grammar, their pronunciation and their most common
                        words.</p>
                    <p>Telefon: +90 539 438 44 56</p><a href="https://wa.me/905394384456"><i class="fa fa-whatsapp" aria-hidden="true"></i> Whatsapp: +90 539 438 44 56</a>
                    <p>Email:<a href="#">info@aymedya.com</a></p>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="widget">
...
<footer class="footer bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2023&nbsp;<a href="<?php echo e(url('index')); ?>">AY MEDYA</a>, Tüm Hakları
                    Saklıdır.</p>
            </div>
            <div class="col-sm-6">
...
<?php /**PATH C:\xampp\htdocs\MVC\resources\views/static/footer.blade.php ENDPATH**/ ?>