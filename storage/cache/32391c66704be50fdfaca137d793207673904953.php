...
<?php echo $__env->make('static.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <section class="module bg-dark-60 about-page-header" data-background="assets/images/about_bg.jpg" style="background-image: url(<?php echo e(assets('images/about_bg.jpg')); ?>);">
                <div class="container">
                    <div class="row">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MVC\resources\views/about.blade.php ENDPATH**/ ?>