...
<?php $__env->startSection('content'); ?>
    ...
    <section class="module bg-dark-60 about-page-header" data-background="<?php echo e(assets('images/cekimmekanlari1.jpg')); ?>"
             style="background-image: url(<?php echo e(assets('images/cekimmekanlari1.jpg')); ?>);">
        <div class="container">
            <div class="row">
    ...
    <div class="container">
        <div class="row list-page mb-15">
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/PLATO.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/Sahil.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/TARLA.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('/images/thumbs/AdileSultanKasri.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/KucuksuKasri.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/SaitHalimPasaYalisi.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/AtaturkArboretum.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/Kapadokya.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/SaldaGolu.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/CamlicaKorusu.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/BelgradOrmani.jpg')); ?>"
            ...
            <div class="col-12 col-sm-6 col-md-4 mt-15 mb-15">
                <div class="item"><a href="#">
                        <figure><img loading="lazy"
                                     src="<?php echo e(assets('images/thumbs/Sutunlar.jpg')); ?>"
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MVC\resources\views/shooting.blade.php ENDPATH**/ ?>