...
<?php $__env->startSection('homesection'); ?>
    <?php echo $__env->make('componenents.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
            ...
            <div class="row multi-columns-row">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    ...
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_18.jpg')); ?>"
                                                      title="Title 1"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/18.jpg')); ?>"
                                        alt="Gallery Image 1">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_34.jpg')); ?>"
                                                      title="Title 2"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/34.jpg')); ?>"
                                        alt="Gallery Image 2">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_30.jpg')); ?>"
                                                      title="Title 3"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/30.jpg')); ?>"
                                        alt="Gallery Image 3">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_2.jpg')); ?>"
                                                      title="Title 4"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/2.jpg')); ?>" alt="Gallery Image 4">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                            </a></div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_32.jpg')); ?>"
                                                      title="Title 5"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/32.jpg')); ?>"
                                        alt="Gallery Image 5">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_20.jpg')); ?>"
                                                      title="Title 6"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/20.jpg')); ?>"
                                        alt="Gallery Image 6">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_38.jpg')); ?>"
                                                      title="Title 7"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/38.jpg')); ?>"
                                        alt="Gallery Image 7">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
                ...
                <div class="col-sm-6 col-md-3 col-lg-3">
                    <div class="gallery-item">
                        <div class="gallery-image"><a class="gallery" href="<?php echo e(assets('images/gallery/big/big_39.jpg')); ?>"
                                                      title="Title 8"><img
                                        src="<?php echo e(assets('images/gallery/thumbnail/full_4/39.jpg')); ?>"
                                        alt="Gallery Image 8">
                                <div class="gallery-caption">
                                    <div class="gallery-icon"><span class="icon-magnifying-glass"></span></div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MVC\resources\views/home.blade.php ENDPATH**/ ?>