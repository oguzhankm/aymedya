...
<?php $__env->startSection('content'); ?>
    ...
    <section class="module bg-dark-60 about-page-header" data-background="<?php echo e(assets('images/about_bg.jpg')); ?>"
             style="background-image: url(<?php echo e(assets('images/about_bg.jpg')); ?>);">
        <div class="container">
            <div class="row">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MVC\resources\views/reservation.blade.php ENDPATH**/ ?>