...
<nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="<?php echo e(url('index')); ?>">AY MEDYA | PHOTOGRAPHY</a>
        </div>
        <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a class="dropdown-toggle" href="<?php echo e(url('home')); ?>" data-toggle="dropdown">ANASAYFA</a>
                    <ul class="dropdown-menu">
                        <li><a href="index_agency.html">Agency</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">DIŞ ÇEKİM</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">PORTFOLYO</a>
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="<?php echo e(url('about')); ?>" data-toggle="dropdown">HAKKIMIZDA</a>
                    <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Instagram</a>
                    <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">İletişim</a>
                    <ul class="dropdown-menu" role="menu">
...
</nav><?php /**PATH C:\xampp\htdocs\MVC\resources\views/layouts/static/navbar.blade.php ENDPATH**/ ?>